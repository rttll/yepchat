    ...
    <div class="bg-white w-full max-w-md mx-auto shadow-xl md:mt-24 relative rounded">
      ...
      <div class="px-8 my-10">
        <label for="name" class="block shadow-md">
          <input v-model="name" type="text" id="name" class="border p-4 block w-full rounded" placeholder="Username" autocomplete="off">
        </label>
      ...
      <div class="bg-gray-100 py-4 px-8 flex justify-end">
        <button 
          v-on:click="save"
